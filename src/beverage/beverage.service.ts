...
import normalizeBeverageDetails from 'utils/normalizers/output/beverages';
...
export class BeverageService {
	...
	async getAllBeveragesDetails(language: SiteLanguage) {
		const result = await this.beverageModel.aggregate([
			// ------------------------------------------------
